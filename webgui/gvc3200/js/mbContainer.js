...
(function(jQuery){
	...
	jQuery.containerize={
		...
		build:function(el){
			...
			var header = jQuery("<div/>").addClass("mbc_header").attr("tabindex", "-1");
			var title = jQuery("<div/>").addClass("mbc_title").attr("tabindex", "-1").html(titleText);
			var buttonBar = jQuery("<div/>").addClass("mbc_buttonBar").attr("tabindex", "-1");
			var toolBar = jQuery("<div/>").addClass("mbc_toolBar").attr("tabindex", "-1");
		...
		//modify by ahluo on 20140925 .html(label)
			return jQuery("<button/>").addClass("mbc_button"+ (className ? " "+ className : "") ).attr("tabindex", "-1").attr("idx", idx).html("").click(function(e){
