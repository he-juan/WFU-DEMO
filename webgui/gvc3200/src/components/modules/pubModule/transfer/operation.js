...
var TransferOperation = function (_React$Component) {
    ...
    TransferOperation.prototype.render = function render() {
        var _props = this.props,
            ...
            moveTop = _props.moveTop,
            moveUp = _props.moveUp,
            moveDown = _props.moveDown,
            moveBottom = _props.moveBottom,
            leftArrowText = _props.leftArrowText,
            rightArrowText = _props.rightArrowText,
            topArrowText = _props.topArrowText,
            upArrowText = _props.upArrowText,
            downArrowText = _props.downArrowText,
            bottomArrowText = _props.bottomArrowText,
            leftActive = _props.leftActive,
            rightActive = _props.rightActive,
            topActive = _props.topActive,
            upActive = _props.upActive,
            downActive = _props.downActive,
            bottomActive = _props.bottomActive,
        ...
        var moveTopButton = _react2["default"].createElement(
            _button2["default"],
            { type: 'primary', size: 'small', disabled: !topActive, onClick: moveTop },
            _react2["default"].createElement(
                'span',
                null,
        ...
        var moveUpButton = _react2["default"].createElement(
            _button2["default"],
            { type: 'primary', size: 'small', disabled: !upActive, onClick: moveUp },
            _react2["default"].createElement(
                'span',
                null,
        ...
        var moveDownButton = _react2["default"].createElement(
            _button2["default"],
            { type: 'primary', size: 'small', disabled: !downActive, onClick: moveDown },
            _react2["default"].createElement(
                'span',
                null,
        ...
        var moveBottomButton = _react2["default"].createElement(
            _button2["default"],
            { type: 'primary', size: 'small', disabled: !bottomActive, onClick: moveBottom },
            _react2["default"].createElement(
                'span',
                null,
