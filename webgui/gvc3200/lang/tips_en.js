...
tip_item.push (
    ...
    new TipsDef("SIP Transport",
        "Determines the network protocol used for the SIP transport. For IPVideoTalk, users can choose from TCP/TLS. For other accounts, users can choose from TCP/UDP/TLS."),
	...
	new TipsDef("Start Video Automatically",
		"Defines whether to enable video automatically when there is an incoming call or a call from the contacts, conference or MPK. If set to \"Yes\", the video will be started automatically in the above cases. If set to \"No\", answer or dial the call via SIP audio."),
	...
	new TipsDef("Noise Shield",
		"If set to \"Yes\", the voice of knocking table and turning over papers will be eliminated in call clearance (no one is speaking), the default setting is \"Yes\"."),
    ...
    new TipsDef("Allow DHCP Option 43 and Option 66 Override Server",
        "If DHCP option 43 or DHCP option 66 is turned ON in the LAN, the TFTP server setting can be overridden. The default setting is \"Yes\"."),
    ...
    new TipsDef("Auto Reboot to Upgrade Without Prompt", 
		"If set to \"Yes\", the device will automatically start upgrading after downloading the firmware files. Otherwise, users would need to confirm in the prompted message before upgrading process is started. The default value is \"Yes\"."),
