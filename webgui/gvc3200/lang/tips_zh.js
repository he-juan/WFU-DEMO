...
tip_item.push (
    ...
    new TipsDef("Dial Plan Prefix", "拨号前缀",
        "设置拨号前缀。使用该帐号拨打的一切号码将自动添加该前缀。如拨号前缀为5，设备上拨打的号码为337，则正常呼出的号码为5337。"),
    new TipsDef("DialPlan", "拨号规则",
        "拨号规则:<br>1. 有效值: 1,2,3,4,5,6,7,8,9,0,*,#<br>• 拨号规则: x – 表示任何0-9数;<br>• xx - 标准两位任何0-9数;<br>• ^ - 拒绝;<br>• [3-5] – 拨数3, 4, or 5;<br>• [147] – 拨数1, 4, or 7;<br>2. <2=011> - 当拨号数字2的时候将替换为011<br>3. 实例<br>例子1）: {[369]11 | 1617xxxxxxx} – 允许311, 611, 911, 和任何10位数字开始为1617的呼叫出去<br>例子 2）: {^1900x+ | <=1617>xxxxxxx} – 将拒绝拨打号码为1900开头的号码，与拨打任何7位数增加前缀1617。<br>4. 设置 {x+} 允许所有的号码呼出。<br>注意：如果第一个账号呼出失败可能是默认的拨号规则引起，更改拨号规则与账号2/3相同即可。"),
    ...
    new TipsDef("Disable Presentation", "禁止演示",
        "如果设置为“是”，在会议中设备将无法开启演示和接收演示。默认设置为“否”。"),
 ...
 /*Maintenance Web Access*/
   ...
   new TipsDef("Flicker Control", "闪动控制",
    ...
    new TipsDef("Enter Sleep Mode", "休眠时间",
        "满足休眠条件后，终端无任何其他操作到休眠状态所需要的时间。如果将休眠时间设置为“从不”，终端将不会自动休眠。默认值为“30分钟后”。"),
