...
PeerConnection.prototype.setRemoteDescriptionSuccess = function () {
    ...
    if(!This.gsRTC.sendCtrlPresentation === true){
...
GsRTC.prototype.modifyPort = function(sdp){
    log.info('modify port')
    // let This = this
    let parseSDP = SDPTools.parseSDP(sdp)
    parseSDP.media.map (function(item){
        if(item.port === 0){
            item.port = 9
        }
    })
