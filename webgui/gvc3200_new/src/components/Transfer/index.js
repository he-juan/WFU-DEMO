...
require("antd/lib/transfer/style/index.css");
  ...
  function Transfer(props) {
    ...
    _this.moveTo = function (direction) {
      ...
      if (direction === 'top') {
        ...
        newTargetKeys = direction === 'right' ? newMoveKeys.concat(targetKeys) : targetKeys.filter(function (targetKey) {
    ...
    _this.renderTransfer = function (transferLocale) {
      return React.createElement(ConfigConsumer, null, function (_ref) {
        ...
        var _this$props3 = _this.props,
            ...
            targetKeys = _this$props3.targetKeys,
        ...
        return React.createElement("div", {
          ...
          bottomArrowText: '',
          moveToBottom: _this.moveToBottom,
