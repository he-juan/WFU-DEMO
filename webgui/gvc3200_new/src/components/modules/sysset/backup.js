    ...
    render() {
        ...
        return (
            <Modal
                ...
                footer = {[
                    <Button type="primary" disabled={this.state.backupbtndisable} onClick={this.handleAddOk}>{callTr("a_306")}</Button>,
                ...
                <div>
                    ...
                    <div className = "restoreProcess" style={{display:contactsDisplay}}>
                        <div className="ProcessItem">
                            ...
                            <div className="infor">
                                <p style={{color:'#0d1017', "fontWeight":'bold'}}>{callTr("a_310")}</p>
...
class Backup extends Component {
    ...
    handleBackupInfo = (result) => {
        ...
        //var isContacts = backInfoArr[3] == "1" ? "a_310" : "";
        var isContacts;
        var isCallhistory;
        if (this.props.oemId == "54") {
            isContacts = "";
            ...
            isContacts = backInfoArr[3] == "1" ? "a_310" : "";
                    ...
                    <div className="backupdiv" style={{display:this.state.backupdisplay}}>
                        ...
                        <div className="backupinfo">
                            ...
                            <div className="operationDiv" style={{'text-align':'right'}}>
                                <Modal visible={this.state.restoreCofirmModalVisible} title={this.tr("a_9006")} className="confirm-modal"
                                ...
                                <Button className="select-restory" type="primary" onClick={this.showRestoryConfirmModal}><i></i>{this.tr("a_9006")}</Button>
                                ...
                                <Button type="primary" onClick={this.showBackupModal}>{this.tr("a_306")}</Button>
                            </div>
                        </div>
                    </div>
                </div>
