...
import GeneralForm from "./h323Account/general";
import CallForm from "./h323Account/call";
import CodecFrom from "./h323Account/codec"
...
class h323Acct extends Component {
    constructor(props) {
        super(props);
    }
    render() {
        return (
            <Content className="content-container config-container">
                <div className="subpagetitle">H.323</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Enhance(h323Acct))
