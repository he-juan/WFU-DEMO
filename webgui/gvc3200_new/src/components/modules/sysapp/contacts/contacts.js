        ...
        return (
            <div id="contact-content" style={{margin: 10}}>
                <Row type="flex" justify="around" align="middle" style={{ height: '60px', fontSize: '0.875rem'}}>
                    ...
                    <Col span={6}>
                        <Search style={{marginTop:'-0.5rem',height:'32px'}} placeholder={ `${callTr('a_65')} ${mContactNum} ${callTr('a_310')}` } onSearch={this.handleSearch} onChange={this.handleListenValue} enterButton/>
                    </Col>
                </Row>
                {
