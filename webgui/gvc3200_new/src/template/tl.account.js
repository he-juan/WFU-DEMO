          ...
          sub: [
            ...
            },
            {
              ...
              // DTMF
                ...
                // 语音编码
                { lang: 'acct_060', p: ['P551', 'P552', 'P553', 'P554', 'P555'] },
                // 编码协商优先级
                ...
                // H.264视频大小
                { lang: 'acct_154', p: 'P2507' },
                // 视频比特率
                { lang: 'acct_155', p: 'P2515' },
                // 视频帧率
          ...
          sub: [
            ...
            },
            {
              ...
              sub: [
                ...
                // 注册期限内重新注册等待时间(秒)
                { lang: 'acct_020', p: 'P2830', denyModel: 'GVC3220' },
                // 订阅超时(分钟)
                ...
                // SIP Timer D间隔时间
                { lang: 'acct_054', p: 'P2887', denyModel: 'GVC3220' },
                // 从路由移除OBP
