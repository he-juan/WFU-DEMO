...
tip_item_en.push (
    ...
    new TipsDef("Auto Answer",
        "If set to \"Yes\", the device will automatically answer incoming calls after a short reminding beep. If set to \"Enable Intercom/Paging\", it will answer the call based on the SIP info header sent from the server/proxy. The default setting is \"No\"."),
    ...
    new TipsDef("Account Ring Tone",
        "Selects different ringtones from the dropdown menu."),
    ...
    new TipsDef("OpenVPN Type",
        "Simple mode only supports some basic or common parameters configuration; Professional mode suppports configuration file upload, which is totally customized by need, please refer to https://openvpn.net for more information."),
    new TipsDef("OpenVPN Upload", 
