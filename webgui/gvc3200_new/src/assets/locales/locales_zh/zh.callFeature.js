...
export default {
  ...
  call_008: '无呼叫等待音',
  call_008_tip: '若此项设置为“否”，用户在通话中有另外一路电话接入时，没有呼叫等待音提示，只有LED指示灯闪烁作为提示。默认设置为“否”。',

  call_009: '禁用勿扰模式提醒音',
  call_009_tip: '若设置为“是”，电话开启了免打扰后，来电时将不会有铃声进行提醒。默认设置为“否”。',
  ...
  call_012: '禁止通话中DTMF显示',
  call_012_tip: '当设置为“是”时，通话中输入的DTMF将不会被显示。默认设置为“否”。',

  call_013: '过滤字符集',
  call_013_tip: '设置呼入呼出号码时需要过滤的字符。可设置多个字符。如设置[()-]，拨打电话(0571)-8800-8888时，将会自动将其中的符号()-过滤掉，拨打057188008888。注：设备本地端呼叫页面过滤字符集功能不生效。',

  call_014: '禁止呼叫等待',
  call_014_tip: '默认不勾选。当两台设备建立通话时，禁止第三方的呼叫等待。',

  call_015: '禁用IP拨打模式',
  call_015_tip: '默认不勾选。如果勾选，直接IP呼叫功能叫被禁止使用。',
  ...
  call_023: '水平偏移',
  call_023_tip: '左右微调会场名在本地主视频上的显示位置。取值范围：0%～96%。默认值为“0%”。',

  call_024: '垂直偏移',
  call_024_tip: '上下微调会场名在本地主视频的显示位置。取值范围：0%～96%。默认值为“0%。',
  ...
  call_030: '音频设备',
  call_030_tip: '该项是选择通话/媒体声音的输入输出设备，分为自动、蓝牙、USB、HDMI、内置扬声器和鹅颈麦。选择“USB”，声音从USB设备输入和输出。选择“蓝牙”，声音从蓝牙设备输入和输出。选择“HDMI”，声音从GVC内置Mic输入，从HDMI 设备输出。选择“内置扬声器”，声音从GVC内置Mic输入，从内置扬声器输出。选择“鹅颈麦”，并且输出设备为HDMI时, 声音从USB设备输入，从HDMI设备输出。选择“自动”，会自动检测是否有连接USB、蓝牙、HDMI 、内置扬声器，当同时有连接其中两个或以上，声音输入和输出优先级为蓝牙>USB>HDMI>内置扬声器。默认为自动。',
