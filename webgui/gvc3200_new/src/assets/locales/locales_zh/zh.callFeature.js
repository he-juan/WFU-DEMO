...
export default {
  ...
  call_037_tip: '设置视频显示模式为“原始视频”或“根据比例补充黑边”。若设置为“原始视频”，则设备显示视频时将根据对方发送来的视频进行显示，若视频显示比例与设备显示比例不同，将会进行适当的拉伸/压缩以显示下完整视频；若设置为“根据比例补充黑边”，则设备将会根据发送来的视频比例进行显示，若有多余部分，将使用黑边进行补充。默认设置为“原始视频”。',
  ...
  call_040: '演示视频分辨率',
  call_040_tip: '演示流支持的视频大小。',

  call_041: '演示视频码率',
  call_041_tip: '配置视频电话的演示流比特率，可以根据网络环境调整的演示流比特率。如果带宽允许的情况下建议增加比特率大小；如果带宽不够，演示质量将降低。',

  call_042: '演示视频帧率',
  call_042_tip: '配置启用演示时的视频帧率。'
}
