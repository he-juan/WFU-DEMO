...
module.exports = function(webpackEnv) {
      ...
      loaders.push({
        ...
        options: {
          ...
          modifyVars: {
            ...
            'btn-disable-color': '#a7b1bc',
            'btn-disable-bg': '#e8ecf0',
            'btn-disable-border': '#e8ecf0',
            'checkbox-size': '14px',
            'radio-size': '14px'
          },
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        '@': paths.appSrc,
        '@ant-design/icons/lib/dist$': path.resolve(paths.appSrc, './rewriteAntdIcon.js')
      },
      plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            inject: true,
            chunks: ["quickconfig"],
            template: paths.appHtmlQuickConfig,
