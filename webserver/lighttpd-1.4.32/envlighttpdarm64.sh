...
export LDFLAGS="-nostdlib -Bdynamic -pie -fPIE -Wl,-rpath-link=${ANDROID_ROOT}/out/target/product/gvc3220_box/system/lib64/ \
    -Wl,-z,now -Wl,-z,relro -Wl,-Bstatic -lssl_static2 -lcrypto_static2 -Wl,-Bdynamic \
    -L${ANDROID_ROOT}/out/target/product/gvc3220_box/system/lib64/  \
    -L${ANDROID_ROOT}/out/target/product/gvc3220_box/obj/STATIC_LIBRARIES/libssl_static2_intermediates/ \
    -L${ANDROID_ROOT}/out/target/product/gvc3220_box/obj/STATIC_LIBRARIES/libcrypto_static2_intermediates/"
